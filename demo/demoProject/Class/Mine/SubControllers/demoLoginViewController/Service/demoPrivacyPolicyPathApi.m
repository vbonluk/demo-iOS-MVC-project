 ...
 *  File name       :      demoPrivacyPolicyPathApi.m
 *  Author          :      Vbon
...
@interface demoPrivacyPolicyPathApi ()



@end

@implementation demoPrivacyPolicyPathApi {
}
 ...
 */
- (NSString *)requestUrl {
    return @"/individual_agent/api_mobile/system/getHTMLPath";
}
 ...
 */
- (Class)modelClass {
    return [demoPrivacyPolicyPathModel class];
}
